...
public class SamplingNodeExtension implements NodeExtension {
    ...
    @Override
    public InboundHandler[] createInboundHandlers(EndpointQualifier qualifier, DefaultConnection connection, IOService ioService) {
        return nodeExtension.createInboundHandlers(qualifier, connection, ioService);
    }

    @Override
    public OutboundHandler[] createOutboundHandlers(EndpointQualifier qualifier, DefaultConnection connection, IOService ioService) {
