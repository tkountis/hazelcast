...
public interface NodeExtension {
     ...
     */
    InboundHandler[] createInboundHandlers(EndpointQualifier qualifier, DefaultConnection connection, IOService ioService);
     ...
     */
    OutboundHandler[] createOutboundHandlers(EndpointQualifier qualifier, DefaultConnection connection, IOService ioService);
