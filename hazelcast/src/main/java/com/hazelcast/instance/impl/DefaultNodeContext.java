...
import com.hazelcast.internal.nio.tcp.ConnectionChannelErrorHandler;
...
public class DefaultNodeContext implements NodeContext {
    ...
    public NetworkingService createNetworkingService(Node node, ServerSocketRegistry registry) {
        ...
        NetworkingServiceImpl tcpIpNetworkingService = new NetworkingServiceImpl(config,
                ioService,
                registry,
                node.loggingService,
                metricsRegistry,
    ...
    private Networking createNetworking(Node node) {
        ...
        ChannelErrorHandler errorHandler
                = new ConnectionChannelErrorHandler(loggingService.getLogger(ConnectionChannelErrorHandler.class));
