...
public class OverloadedConnectionsPlugin extends DiagnosticsPlugin {
    ...
    public void run(DiagnosticsLogWriter writer) {
        ...
        Collection<DefaultConnection> connections = getTcpIpConnections();
        for (DefaultConnection connection : connections) {
            clear();
    ...
    private Collection<DefaultConnection> getTcpIpConnections() {
        NetworkingService networkingService = nodeEngine.getNode().getNetworkingService();
        AggregateEndpoint endpointManager = networkingService.getAggregateEndpoint();
        return endpointManager.getActiveConnections();
    }

    private void scan(DiagnosticsLogWriter writer, DefaultConnection connection, boolean priority) {
    ...
    private Queue<OutboundFrame> getOutboundQueue(DefaultConnection connection, boolean priority) {
    ...
    private void render(DiagnosticsLogWriter writer, DefaultConnection connection, boolean priority, int sampleCount) {
